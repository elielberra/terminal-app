...
INSTRUCTIONS_ENG="- If you’re a ${CYAN}random user${RESET}, type ${GREEN}eliel champion${RESET}. "\
...
INSTRUCTIONS_ESP="- Si sos un ${CYAN}usuario random${RESET}, escribí ${GREEN}eliel champion${RESET}. "\
