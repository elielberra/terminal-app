...
INSTRUCTIONS_ENG="- If you’re a ${CYAN}curious visitor${RESET}, type ${GREEN}eliel champion${RESET}. "\
...
INSTRUCTIONS_ESP="- Si sos un ${CYAN}visitante curioso${RESET}, escribí ${GREEN}eliel champion${RESET}. "\
"Tengo una sorpresa preparada para vos. "\
